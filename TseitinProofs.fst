...
//             // let ghost tau1 : list bool = exists (tau1 : list bool) . L.length tau1 = v in
//             // negate_literal v1 tau1
//             // let (|tau1, _|) = exists (tau1 : list bool) . L.length tau1 = v in
//             // negate_literal v1 tau1     
//             let tau1 = exists_elim (exists (tau1 : list bool) . L.length tau1 = v) in
//             negate_literal v1 tau1
//       in
//       forall_intro (move_requires aux) 
