module LemmasForClauses.OrClauses
...
let prove_same_value_can_extend_or (f1:formula_t) (rf1 : list (list int)) (v1:int)
    ...
    = LP.append_assoc rf1 rf2 (or_clauses v1 v2 v);
      ...
      let aux (tau : list bool) 
          ...
          = assert (variables_up_to_cnf_formula rf (L.length tau));
            ...
            append_variables_in_interval rf2 (or_clauses v1 v2 v) n start_interval end_interval;
            assert (variables_up_to_cnf_formula (rf2 @ (or_clauses v1 v2 v)) (L.length tau));

            true_parts_of_cnf_formula (rf1 @ rf2) (or_clauses v1 v2 v) tau;
            true_parts_of_cnf_formula rf1 (rf2 @ (or_clauses v1 v2 v)) tau;
